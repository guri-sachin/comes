...
function Product() {
    ...
    {
      if(e.keyCode==13 || e.target.value =="Log In"){
...
setProducts3(data1)
 ...
 <div class="wrapper fadeInDown">
  <div id="formContent">
    ...
    <form>
      <input type="text" id="login" class="fadeIn second" name="login" placeholder="login" onChange={handelDemo3} onKeyDown={Show1}/>
      <input type="text" id="password" class="fadeIn third" name="login" placeholder="password" onChange={handelDemo2} onKeyDown={Show1}/>
