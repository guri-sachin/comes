...
function Dashboard()
{
    ...
    function Saveproduct(e){
      ...
      console.log(data);
         axios.post("http://localhost:4200/ca",data).then(
             res=> console.log(res)
           )
...
<!-- Content Wrapper --> */}
 ...
 <div class="col-md-2" >categories</div>
    ...
    <div class="col-md-10">
      <input type=""  class="form-control" name="categories"  placeholder="categories" id="Location" required onChange={handelDemo1}/>
    </div>
