...
<h1 class="h3 mb-0 text-gray-800">List of all products</h1>  
      ...
      <thead>
        <th>name</th><th>price</th><th>sku</th><th class="bl5" >sale Percentage</th><th class="bl5">Sale Price</th><th>Description</th><th>image</th><th>categories</th><th>sub categories</th>
              ...
              return(
                  <tr key={index}>
                      ...
                      <td> <img src={item} width="50" height="40"/>
                         ...
                         <td><Button type="button"  variant="danger" id={item.id}  onClick={onEdit}>EDIT</Button></td>
                     </tr>
                 );
             })}
         </tbody>
