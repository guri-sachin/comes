...
const [product,setProducts] =useState([]);
 ...
 function Shows(e){
  ...
  axios.get(`http://localhost:4200/deleteuser/${id}`).then(
       ...
       {/*  <!-- Begin Page Content --> */}
        <div class="container-fluid">
         ...
         {/*  <!-- Page Heading --> */}
          ...
          <div >
<h1 class="h3 mb-0 text-gray-800">Blocked User List</h1>  
        <Table striped bordered hover >
      <thead>
        <th>Full Name</th><th>Email</th><th>Date</th><ht>action</ht>
      </thead>
         <tbody>
             {product.map((item,index)=>{
                 return(
                     <tr key={index}>
                         ...
                         <td><Button type="button"  variant="danger" id={item.id} onClick ={Shows} >block user</Button></td>
                     </tr>
                 );
             })}
         </tbody>
