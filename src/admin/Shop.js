...
function Admin()
{
  ...
  console.log(product)
  useEffect(()=>{
     axios.get("http://localhost:4200/showimage").then(res=>setProducts(res.data));
...
<Form.Group controlId="formBasicEmail">
                ...
                <Form.Control type="" placeholder="enter product name" onChange={handelDemo7}  />
                </Form.Group>
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
      ...
      <div >
<h1 class="h3 mb-0 text-gray-800">List of all Cate</h1>  
    <Table striped bordered hover >
  <thead>
    <th>Show Cate</th><th>image</th>
  </thead>
     <tbody>
         {product.map((item,index)=>{
             return(
                 <tr key={index}>
                  ...
                  <td> <img src={item.image} width="200" height="100"/>
                </td>
