...
async function bhbbhb(e){
  ...
  const data1 = await response.json();
    ...
    if(story === undefined){
      ...
      const data5 ={"email":fullname,"image":image,"price":price,"name":pname};
...
<br></br>
<br></br>
<button type="button" class=" ab61" onClick={() => bhbbhb()} >Move To Wishlist</button><br/>

<br></br>
<button type="button" class=" ab62">Move To Card</button>
</div>
<div class="col-md-7">
