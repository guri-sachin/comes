...
function Lowest(a,b){
          ...
          var profud = (products1.map((item,hanel)=>item))
          setProducts1(profud.sort((a, b) => a.price - b.price))
      console.log(olpk);
...
function Higest(){
  ...
  var profud = (products1.map((item,hanel)=>item))
  setProducts1(profud.sort((a, b) => b.price - a.price))
...
{products1.length> 0 ? products1.map((item, k) => (
