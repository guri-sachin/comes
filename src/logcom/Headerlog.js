  ...
  navigate('/Wishlistlog',{state:data3}) 
    ...
    function Shear(e){
      if(e.keyCode==13 || e.target.value ==13){
        navigate("/Papperalllog",{ state: products8 })
            }
            ...
            <div class="row">
              ...
              <div class="col-md-7">
                <div class="wrap">
                 ...
                 onKeyDown={Shear}/>
                    <button type="submit" class="searchButton" style={{marginTop:"6px"}} value={"13"}  onClick={Shear}>
                      <i class="fa fa-search"></i>
                    </button>
                  </div>
                </div>
              </div>
              <div class="col-md-4"><div class="ab4"><div class="row"><div class="col-md-2 ab79"><a href="/"><img src="images/help.jpg" /></a></div>
