...
console.log(location.state[0].fullname)
...
<div class="col-md-3"><div class="ab78">{location.state[0].fullname}</div></div>
</div>
...
<div class="col-md-4"><div class="ab78">{location.state[0].email}</div></div>
</div>
