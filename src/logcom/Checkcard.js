...
<button type="button" class=" ab60" onClick={() => bhbbhb(item)} value={item.price}>Wishlist</button><br/>
<br></br>
<button type="button" class=" ab60" id={item.id} onClick={Remove}>Delete.</button>
</div>
<div class="col-md-7">
...
<div class="ab43"></div>
<div class="row">
<div class="col-md-7"><div class="ab41 ab90" >Color</div></div>
<div class="col-md-5">
<div class="ab42 ab89" >{item.color}
</div></div>
</div>
<div class="ab43"></div>
...
<div class="col-md-5">
<div class="ab42 ab92" >{item.qty*item.price}
</div></div>
</div>
<div class="ab43"></div>
